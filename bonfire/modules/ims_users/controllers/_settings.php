...
class _settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('IMS_Users.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Settings.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_ims_users())
			{
				...
				Template::redirect(SITE_AREA .'/settings/ims_users');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Settings.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/ims_users');
		}
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Settings.Delete');
