...
class _developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('IMS_Users.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_ims_users())
			{
				...
				Template::redirect(SITE_AREA .'/developer/ims_users');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/ims_users');
		}
	...
	*/
	...
	{
		$this->auth->restrict('IMS_Users.Developer.Delete');
