...
<?php $options = array(
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/settings/ims_users', lang('ims_users_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('IMS_Users.Settings.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/ims_users/delete/'. $id);?>" onclick="return confirm('<?php echo lang('ims_users_delete_confirm'); ?>')" name="delete-me">
