...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="submit" class="btn btn-primary" value="Edit IMS Users" />
            or <?php echo anchor(SITE_AREA .'/developer/ims_users', lang('ims_users_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('IMS_Users.Developer.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/ims_users/delete/'. $id);?>" onclick="return confirm('<?php echo lang('ims_users_delete_confirm'); ?>')" name="delete-me">
