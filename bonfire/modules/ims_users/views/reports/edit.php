...
<?php $options = array(
    ...
    <?php if ($this->auth->has_permission('IMS_Users.Reports.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/ims_users/delete/'. $id);?>" onclick="return confirm('<?php echo lang('ims_users_delete_confirm'); ?>')" name="delete-me">
