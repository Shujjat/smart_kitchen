...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/reports/dishes', lang('dishes_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Dishes.Reports.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/reports/dishes/delete/'. $id);?>" onclick="return confirm('<?php echo lang('dishes_delete_confirm'); ?>')" name="delete-me">
