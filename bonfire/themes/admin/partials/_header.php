...
<head>
    ...
    <script src="http://<?php echo HOST;?>/assets/js/ajax.js" type="text/javascript"></script>
</head>
<body class="desktop">
<!--[if lt IE 7]>
		...
		<div class="navbar navbar-fixed-top" id="topbar" >
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<h1>
                    <?php 
                        echo anchor( '/', $this->settings_lib->item('site.title'), 'class="brand"' );
                    ?></h1>
									...
									<li>
										<div class="inner">
											...
											<div class="toolbar-profile-info">
												<p><b><?php echo $current_user->display_name ?></b>
