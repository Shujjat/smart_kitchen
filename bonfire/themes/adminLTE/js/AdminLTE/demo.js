$(function() {
    ...
    demo_settings.append(
            ...
            "<h4 style='margin: 0 0 5px 0; border-bottom: 1px dashed #ddd; padding-bottom: 3px;'>Institutes</h4>"
            + "<div class='form-group no-margin' id='institutesString'>"
            
            + "</div>"
            );
    demo_settings.append(
            
            "<h4 style='margin: 0 0 5px 0; border-bottom: 1px dashed #ddd; padding-bottom: 3px;'>Campuses</h4>"
            + "<div class='form-group no-margin' id='campusString'>"
    ...
    demo_settings.append(
            ...
            "<h4 style='margin: 0 0 5px 0; border-bottom: 1px dashed #ddd; padding-bottom: 3px;'>Campuses</h4>"
            + "<div class='form-group no-margin' id='themeString'>"
            + themeString
            + "</div>"
            );
    **/
