...
$api_key = "dcf3e374e2f13b1c6e3b83021ecd1d0e";
$api_secret = "pb_sRq4qAcmFolkxsQYF1WcFafTj16yD";
// initialize client object
$api = new FacePPClientDemo($api_key, $api_secret);

// the list of person_name to train and identify for
$person_names=array('salloo','srk','johny','leonardo','tom');
...
*/
$response=identify($api, $person_names[0], $group);
var_dump($response);
...
function start()
{
    $persons=array('salloo.jpg','srk.jpg','johny.jpg','leonardo.jpg','tom.jpg');
    foreach($persons as $person)
    {
        detect($api,'F:\\wamp\\www\\facepp\\assets\\'.$person,$face_ids);
    }
...
function getTrainingUrl($person_name)
{
	...
	return "http://test.shujjat.com/facepp/assets/".$person_name.".jpg";
}
...
{
    // TODO: here is just the fake url
	return 'http://test.shujjat.com/facepp/assets/'.'salman'.".jpg";
}
