...
<section id="register">
	<div class="page-header">
		<h1>It's Free... and we aim to keep it free!<?php //echo lang('us_login'); ?></h1>
	</div>
...
<?php echo form_open('register', array('class' => "form-horizontal", 'autocomplete' => 'off')); ?>
	...
	<br/>
		...
		<!-- End of User Meta -->
        <input  type="checkbox" id="agreement"  onchange="enableSubmit();" /> I agree the 
        <?php echo anchor('institutes/terms_and_conditions','Terms and Conditions');?> and the 
        <?php echo anchor('institutes/privacy_policy','Privacy Policy');?>.
        </div>
	<div class="control-group" >
		<label class="control-label" for="submit">&nbsp;</label>
		<div class="controls">
			<input class="btn btn-primary" onchange="enableSubmit();"type="button" name="submit" id="submit_button" value="<?php echo lang('us_register'); ?>"   />
		</div>
	</div>
