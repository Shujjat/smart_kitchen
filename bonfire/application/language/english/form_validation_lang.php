...
$lang['date_greater_than']		= "%s must contain a date greater than %s.";
$lang['date_greater_than_or_equal_to']		= "%s must contain a date greater than or equal to %s.";
$lang['date_less_than']		= "%s must contain a date less than %s.";
