...
//$route[SITE_AREA .'/content/batches']				= "admin/content/programs";
$route[SITE_AREA .'/content']				        = "";
$route[SITE_AREA .'/content/parents']				= "";
//$route[SITE_AREA .'/content/batches']				= "admin/content/batches/create";
