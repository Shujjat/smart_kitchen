<?php
session_start();
ini_set('max_execution_time', 200000000000);
...
{
     $host='http://127.0.0.1/delete/smart_kitchen/';
...
else
{
 ...
 // define('ENVIRONMENT', 'development');
  ...
  // define('THEME','adminLTE2');   
   ...
   //define('THEME','printing');
   
	
/**
 * 
 * Defines deployment mode (DM) for different needs.
 * Current modes are: regular, SaveTrees (ST), dedicated, exams_only ,question_paper_maker_only
