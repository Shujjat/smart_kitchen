    ...
    case EnvayaSMS::ACTION_OUTGOING:
        ...
        while ($file = readdir($dir)) 
        {
            ...
            //if ($file!='.' and $file!='..')
            {
                ...
                $data =  json_encode(trim(file_get_contents($OUTGOING_DIR_NAME.'/'.$file)));
                $data=preg_replace('@[\x00-\x1f\x7f-\xff]@e', '" (0x" . dechex(ord("\\0")) . ") "', $data);
                //unlink($OUTGOING_DIR_NAME.'/'.$file);
